...
| [`version_resource`](#paper_trail-version_resource){: #paper_trail-version_resource } | `atom` |  | Module for the auto-generated version resource. Defaults to `SourceResource.Version`. Set when that name is already used by another resource in your app. |
